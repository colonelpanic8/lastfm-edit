...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let test_track = recent_tracks.iter()
    ...
    if let Some(timestamp) = test_track.timestamp {
        println!("Using track: '{}' by '{}'", test_track.name, test_track.artist);
        ...
        println!("  track_name_original: {:?}", minimal_edit.track_name_original);
        println!("  album_name_original: {:?}", minimal_edit.album_name_original);
        println!("  artist_name_original: {:?}", minimal_edit.artist_name_original);
        println!("  album_artist_name_original: {:?}", minimal_edit.album_artist_name_original);
