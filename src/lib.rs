...
pub use types::{
    ...
    LastFmError, OperationalDelayConfig, RateLimitBehavior, RateLimitConfig, RateLimitState,
    RateLimitStateWatcher, RateLimitType, RequestInfo, RetryConfig, RetryResult, ScrobbleEdit,
